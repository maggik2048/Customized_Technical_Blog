...
type CodeProps = Components["code"] extends React.ComponentType<infer P>
  ? P
  : any;
...
export default function CodeBlock_black({
  inline,
  className,
  children,
  ...
  /* =========================
     INLINE DETECTION
  ========================= */
  const isInline = inline || (!className && text.length < 80 && !text.includes("\n"));
